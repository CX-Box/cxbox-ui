...
import { WidgetField, FieldType } from '@cxbox-ui/schema'
 ...
 */
export const screenReducerBuilder = (builder: ActionReducerMapBuilder<ScreenState>) =>
    builder
...
//  * and passing it as `equals` filter to Cxbox API where it transformed to a day range;
//  *
