...
import { PendingValidationFails, PendingValidationFailsFormat, ViewState, PendingDataItem } from '../interfaces'
 ...
 */
export const viewReducerBuilder = (builder: ActionReducerMapBuilder<ViewState>) =>
    builder
...
// .addMatcher(isAnyOf(bcNewDataFail, bcFetchRowMetaFail), (state, action) => {
//     state.metaInProgress[action.payload.bcName] = false
// })
// .addMatcher(isAnyOf(forceActiveChangeFail, bcSaveDataFail, sendOperationFail), (state, action) => {
